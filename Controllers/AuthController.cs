...
namespace VidaPlus.Server.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        // Registro de novo usuário (Admin ou Profissional)
        [HttpPost("register")]
        ...
        // Autenticação de usuário de acordo com o perfil (Admin, Profissional)
        [HttpPost("login")]
        public async Task<IActionResult> Login([FromBody] LoginDto dto)
        {
            ...
            // Se não for usuário base (Admin ou Profissional), tenta buscar paciente
